...
<body>
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
                    ...
                    <el-form-item label="权限" prop="role">
                        <el-radio-group v-model="ruleForm.role">
                            <el-radio disabled label="1">管理员</el-radio>
                            <el-radio disabled label="2">一般用户</el-radio>
                        </el-radio-group>
                    </el-form-item>
                    <el-form-item>
    ...
    <script>
        const useradd = new Vue({
            ...
            methods: {
                onSubmit() {
                    console.log(useradd.ruleForm.role);
                    if (useradd.ruleForm.password1 == '' || useradd.ruleForm.password2 == '') {
                        useradd.$message({
                            message: '密码不能为空',
                            type: 'warning',
                            duration: 1500
